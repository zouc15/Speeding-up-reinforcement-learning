...
class BrainDQN:
	...
	def createQNetwork(self):
		...
		# hidden layers
		h_conv1 = tf.nn.relu(self.conv2d(stateInput,W_conv1,4,1) + b_conv1)
		h_pool1 = self.max_pool_2x2(h_conv1)

		h_conv21 = self.conv2d(h_pool1,W_conv21,1,1)
		h_conv22 = self.conv2d(h_conv21,W_conv22,2,RANK)
		h_conv23 = self.conv2d(h_conv22,W_conv23,2,RANK)
		h_conv24 = tf.nn.relu(self.conv2d(h_conv23,W_conv24,1,1) + b_conv2)

		h_conv31 = self.conv2d(h_conv24,W_conv31,1,1)
		h_conv32 = self.conv2d(h_conv31,W_conv32,1,RANK)
		h_conv33 = self.conv2d(h_conv32,W_conv33,1,RANK)
		h_conv34 = tf.nn.relu(self.conv2d(h_conv33,W_conv34,1,1) + b_conv3)
	...
	def conv2d(self,x, W, stride, group):
