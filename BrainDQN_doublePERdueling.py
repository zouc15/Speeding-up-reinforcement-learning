...
class BrainDQN:
	...
	def __init__(self,actions):
		...
		self.Loss = []
		# init Q network
		self.stateInput,self.QValue,self.W_conv1,self.b_conv1,self.W_conv2,self.b_conv2,self.W_conv3,self.b_conv3,self.W_fc1,self.b_fc1,self.W_fc2_v,self.b_fc2_v,self.W_fc2_a,self.b_fc2_a = self.createQNetwork()

		# init Target Q Network
		self.stateInputT,self.QValueT,self.W_conv1T,self.b_conv1T,self.W_conv2T,self.b_conv2T,self.W_conv3T,self.b_conv3T,self.W_fc1T,self.b_fc1T,self.W_fc2T_v,self.b_fc2T_v,self.W_fc2T_a,self.b_fc2T_a = self.createQNetwork()

		self.copyTargetQNetworkOperation = [self.W_conv1T.assign(self.W_conv1),self.b_conv1T.assign(self.b_conv1),self.W_conv2T.assign(self.W_conv2),self.b_conv2T.assign(self.b_conv2),self.W_conv3T.assign(self.W_conv3),self.b_conv3T.assign(self.b_conv3),self.W_fc1T.assign(self.W_fc1),self.b_fc1T.assign(self.b_fc1),self.W_fc2T_v.assign(self.W_fc2_v),self.b_fc2T_v.assign(self.b_fc2_v),self.W_fc2T_a.assign(self.W_fc2_a),self.b_fc2T_a.assign(self.b_fc2_a)]
	...
	def createQNetwork(self):
		...
		W_fc2_v = self.weight_variable([512,self.actions])
		b_fc2_v = self.bias_variable([self.actions])
